/**
 * @file latency_runner.hpp
 * @brief Latency benchmark runner.
 *
 * Provides iteration-based latency benchmarking with comprehensive statistics.
 */
 ...
 * and standard deviation. Uses CUDA events for accurate GPU-side timing.
 *

...
function global:iono {
    ...
    $validCommands = @('setup','build','test','coverage','lint','format','clean','doctor','ui','run','help','profile','typecheck')
...
$global:IonoVerbs   = @('setup','build','test','coverage','lint','format','clean','doctor','ui','run','help','profile','typecheck')
